...
class TemplateToaster_Theme_Options extends TemplateToaster_Theme_Options_Dynamic
{
    ...
    public function __construct()
    {
        ...
        $this->sections['error'] = __('Error Page', "Cloth-Store");
        $this->sections['maintenance'] = __('Maintenance', "Cloth-Store");
        $this->sections['shortcodes'] = __('Shortcode', "Cloth-Store");
        $this->sections['googlemap'] = __('GoogleMap', "Cloth-Store");
        //$this->sections['contactus'] = __('Contact Us', "Cloth-Store");
		// $this->sections['seo'] = __('SEO', "Cloth-Store");
        $this->sections['backuppage'] = __('Backup/Recovery', "Cloth-Store");
        $this->sections['export_import'] = __('Export/Import Theme Options', "Cloth-Store");
        $fileName = get_template_directory() . '/content/imports.php';
		if ( file_exists( $fileName ) ) { 
        $this->sections['import_content'] = __('Import Content', "Cloth-Store"); 
        }
    ...
    public function create_setting($args = array())
    {
        ...
        $defaults = array(
            'id' => 'default_field',
            'title' => __('Default Field', "Cloth-Store"),
            'desc' => __('This is a default description.', "Cloth-Store"),
            'std' => '',
            'type' => 'text',
            'section' => 'general',
            'choices' => array(),
    ...
    public function display_page()
    {
       ...
       //display URl error message 
        ...
        {
            echo '<div class="updated fade"><p>' . __('Theme options updated.', "Cloth-Store") . '</p></div>';
		}
        echo '<div id="admin_container" class="wrap">
	            <div class="icon-option"> </div>
	            <h1>' . __('Theme Options For', "Cloth-Store") . '&nbsp;' . $themename . '</h1><br/>';
		...
		echo '</div>';
		echo '<p class="submit">' .
            get_submit_button(__('Save Options', "Cloth-Store"), 'button-primary', 'ttr_submit', false). '</p>';			
		echo '</form>';
        echo '</div>';
    }
       ...
       <div id="content">
                ...
                ?>
                    <table class="table">
                        <tbody>
                        <tr>
                            <td colspan="3"><?php echo(__("To use CONTACT FORM, apply shortcode [contact_us_form]","Cloth-Store"));?></td>

                        </tr>
                        <tr>
                            <td><?php echo(__('Admin Email Address',"Cloth-Store"));?></td>
                            <td colspan="2">
                        ...
                        <!-- Google Captcha -->
                        <tr>
                            <td><?php echo(__('Public Key For Google Captcha',"Cloth-Store"));?></td>
                            <td colspan="2">
                        ...
                        <tr>
                            <td><?php echo(__('Private Key For Google Captcha',"Cloth-Store"));?></td>
                            <td colspan="2">
                        ...
                        <tr>
                            <td><?php echo(__('Error Message',"Cloth-Store"));?></td>
                            <td colspan="2">
                                <input type="textarea" id="ttr_contact_us_error_message" <?php if($value_contact[3]['ttr_contact_us_error_message']){ ?> value="<?php print_r($value_contact[3]['ttr_contact_us_error_message']); ?>" <?php } else {?> value="<?php echo(__("Message was not sent. Try Again.","Cloth-Store"));?>"<?php } ?> name="ttr_contact_us_error_message" />
                        ...
                        <tr>
                            <td><?php echo(__('Success Message',"Cloth-Store"));?></td>
                            <td colspan="2">
                                <input type="textarea" id="ttr_contact_us_success_message" <?php if($value_contact[4]['ttr_contact_us_success_message']){ ?> value="<?php print_r($value_contact[4]['ttr_contact_us_success_message']); ?>" <?php } else {?> value="<?php echo(__("Thanks! Your message has been sent.","Cloth-Store")); ?>"<?php } ?>  name="ttr_contact_us_success_message" />

                            </td>

                        </tr>
                        <tr>
                            <td><?php echo(__('Field Name:',"Cloth-Store"));?></td>
                           <!-- <td><?php echo(__('Field Type:',"Cloth-Store"));?></td>-->
                            <td><?php echo(__('Required',"Cloth-Store"));?></td>
                            <td><?php echo(__('Remove',"Cloth-Store"));?></td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="4"><input type="button" value="<?php echo(__('Add New Field',"Cloth-Store"));?>" class="newfield button-secondary" /></td>
                        </tr>
...
<?php
  ...
  /*  public function display_seoenable_section()
    ...
    public function display_backuppage_section()
    {
        ...
        $this->sections['backupsettings'] = __('Settings', "Cloth-Store");
        $this->sections['backup'] = __('Backup', "Cloth-Store");
        $this->sections['restore'] = __('Restore', "Cloth-Store");
	...
	?>
		<table class="form-table">
	    	<tbody>
	    		<tr>
		            <th>
		            <label><?php echo(__('Export theme options','Cloth-Store'));?></label>
					</th><td>	            
	            	<input id="export_yes" class="button button-primary" type="button" name="exportt" value="<?php echo(__('Export Theme Option','Cloth-Store'));?>" />	            	
	                </td>
	            </tr>
	            <tr>
	               <th>	               
	                <label id="select_file"><?php echo(__('Import theme options? ','Cloth-Store'));?></label>
	                </th><td>
			       	<input type="file" name="importfile" id="importfile" style="height:auto;">
			       	<input id="import_options_yes" class="button button-primary" type="button" value="<?php echo(__('Import Theme Options','Cloth-Store'));?>" name="import_options">			       
	                </td>
	            </tr>
			</tbody>
	    </table>
       ...
       if (!get_option('TemplateToaster_theme_options'))
        ...
        switch ($type) {
            ...
            case 'media':
                ...
                echo '&nbsp;<input type="button" class="ttrbutton btn" value="' . __('Upload', "Cloth-Store") . '"/>';
                if ($desc != '')
                    echo '<br /><span class="description">' . $desc . '</span>';
    ...
    public function get_static_options()
    {
       ...
       /* Error page Settings
        ...
        $this->settings['ttr_error_message_heading'] = array(
            'title' => __('Heading For Error Message', "Cloth-Store"),
            'desc' => __('Change Text For Error Message', "Cloth-Store"),
            'std' => __('This is somewhat embarrassing, isn&rsquo;t it?', "Cloth-Store"),
            'type' => 'textarea',
            'section' => 'error'
        );
        $this->settings['ttr_error_message_content'] = array(
            'title' => __('Content For Error Message', "Cloth-Store"),
            'desc' => __('Change text For Error Message', "Cloth-Store"),
            'std' => __('It seems we can&rsquo;t find what you&rsquo;re looking for. Perhaps searching, or one of the links below, can help.', "Cloth-Store"),
            'type' => 'textarea',
            'section' => 'error'
        );
        $this->settings['ttr_error_message'] = array(
            'title' => __('Enable Content', "Cloth-Store"),
            'desc' => __('Hide/Show Error Message Text', "Cloth-Store"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'error'
        );
        $this->settings['ttr_error_search_box'] = array(
            'title' => __('Enable Search', "Cloth-Store"),
            'desc' => __('Hide/Show Search Box', "Cloth-Store"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'error'
        );
        $this->settings['ttr_error_image'] = array(
            'title' => __('Content Image', "Cloth-Store"),
            'desc' => __('Choose Error Image', "Cloth-Store"),
            'std' => '',
            'type' => 'media',
            'section' => 'error'
        );
        $this->settings['ttr_error_image_enable'] = array(
            'title' => __('Enable Image In Content', "Cloth-Store"),
            'desc' => __('Hide/Show error image', "Cloth-Store"),
            'std' => 0,
            'type' => 'checkbox',
            'section' => 'error'
        );
        $this->settings['ttr_error_image_height'] = array(
            'title' => __('Content Image Height', "Cloth-Store"),
            'desc' => __('Height Of The Error Image', "Cloth-Store"),
            'std' => '',
            'pattern' => '\d+',
            'type' => 'text',
            'section' => 'error'
        ...
        $this->settings['ttr_error_image_width'] = array(
            'title' => __('Content Image Width', "Cloth-Store"),
            'desc' => __('Width of The Error Image', "Cloth-Store"),
            'std' => '',
            'pattern' => '\d+',
            'type' => 'text',
            'section' => 'error'
        ...
        $this->settings['ttr_error_home_redirect'] = array(
            'title' => __('Redirect To Home Page(If Error Page Occurs)', "Cloth-Store"),
            'desc' => __('Redirect to Home Page While Error Occur', "Cloth-Store"),
            'std' => 0,
            'type' => 'checkbox',
            'section' => 'error'
        );
        ...
        $this->settings['ttr_mm_enable'] = array(
            'title' => __('Enable Maintenance Mode', "Cloth-Store"),
            'desc' => __('Enable/Disable Maintenance Mode', "Cloth-Store"),
            'std' => 0,
            'type' => 'checkbox',
            'section' => 'maintenance'
        );
        $this->settings['ttr_mm_title'] = array(
            'title' => __('Title for Maintenance Mode Page', "Cloth-Store"),
            'desc' => __('Set the Title', "Cloth-Store"),
            'std' => '',
            'type' => 'text',
            'section' => 'maintenance'
        );
        $this->settings['ttr_mm_content'] = array(
            'title' => __('Content for Maintenance Mode Page', "Cloth-Store"),
            'desc' => __('Content for Maintenance Mode page', "Cloth-Store"),
            'std' => '',
            'type' => 'textarea',
            'section' => 'maintenance'
        );
        $this->settings['ttr_mm_image'] = array(
            'title' => __('Background Image for Maintenance Mode', "Cloth-Store"),
            'desc' => __('Select Image for Maintenance Mode Page', "Cloth-Store"),
            'std' => '',
            'type' => 'media',
            'section' => 'maintenance'
        );
        ...
        $this->settings['ttr_googlemap_type'] = array(
            'title' => __('Choose the type of Google Map', "Cloth-Store"),
            'desc' => __('Choose the type of Google Map', "Cloth-Store"),
            'type' => 'select',
            'std' => 'Road',
            'choices' => array(
                'choice1' => __('ROAD', "Cloth-Store"),
                'choice2' => __('SATELLITE', "Cloth-Store"),
                'choice3' => __('HYBRID', "Cloth-Store"),
                'choice4' => __('TERRAIN', "Cloth-Store")),
            'section' => 'googlemap'
        );
       $this->settings['ttr_map_latitude'] = array(
            'title' => __('Set Latitude', "Cloth-Store"),
            'desc' => __('Set Latitude', "Cloth-Store"),
            'std' => '25.306944',
            'pattern' => '',
            'type' => 'text',
            'section' => 'googlemap'
        ...
        $this->settings['ttr_map_longitude'] = array(
            'title' => __('Set Longitude', "Cloth-Store"),
            'desc' => __('Set Longitude', "Cloth-Store"),
            'std' => '-257.858333',
            'pattern' => '',
            'type' => 'text',
            'section' => 'googlemap'
        ...
        $this->settings['ttr_map_width'] = array(
            'title' => __('Set Width of Map', "Cloth-Store"),
            'desc' => __('Set Width of Map', "Cloth-Store"),
            'std' => '400',
            'pattern' => '\d+',
            'type' => 'text',
            'section' => 'googlemap'
        ...
        $this->settings['ttr_map_height'] = array(
            'title' => __('Set Height of Map', "Cloth-Store"),
            'desc' => __('Set Height of Map', "Cloth-Store"),
            'std' => '400',
            'pattern' => '\d+',
            'type' => 'text',
            'section' => 'googlemap'
        ...
        $this->settings['ttr_marker_enable'] = array(
            'title' => __('Display Marker', "Cloth-Store"),
            'desc' => __('Enable/Disable the Position Marker', "Cloth-Store"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'googlemap'
        );
        $this->settings['ttr_marker_text'] = array(
            'title' => __('Set Marker Label', "Cloth-Store"),
            'desc' => __('Set Marker Label', "Cloth-Store"),
        ...
        $this->settings['ttr_googlemap_api'] = array(
            'title' => __('Set Google API Key', "Cloth-Store"),
            'desc' => __('Set Google API Key', "Cloth-Store"),
            'std' => '',
            'type' => 'text',
            'patter' => '\d+',
            'section' => 'googlemap'
        ...
        $this->settings['ttr_google_docs_viewer_shortcode'] = array(
            'title' => __('Google Docs Viewer', "Cloth-Store"),
            'desc' => __('To use Copy/Paste the above shortcode', "Cloth-Store"),
            'type' => 'shortcode',
        ...
        $this->settings['ttr_displaying_recent_posts_shortcode'] = array(
            'title' => __('Displaying Related Posts', "Cloth-Store"),
            'desc' => __('To use Copy/Paste the above shortcode', "Cloth-Store"),
            'type' => 'shortcode',
            'std' => '[related_posts]',
            'section' => 'shortcodes'
        ...
        $this->settings['ttr_google_adsense_shortcode'] = array(
            'title' => __('Google AdSense', "Cloth-Store"),
            'desc' => __('To use Copy/Paste the above shortcode', "Cloth-Store"),
            'type' => 'shortcode',
        ...
        $this->settings['ttr_google_chart_shortcode'] = array(
            'title' => __('Google Chart', "Cloth-Store"),
            'desc' => __('To use Copy/Paste the above shortcode', "Cloth-Store"),
            'type' => 'shortcode',
        ...
        $this->settings['ttr_tweet_me_button_shortcode'] = array(
            'title' => __('Tweet Me Button', "Cloth-Store"),
            'desc' => __('To use Copy/Paste the above shortcode', "Cloth-Store"),
            'type' => 'shortcode',
            'std' => '[tweet]',
            'section' => 'shortcodes'
        ...
        $this->settings['ttr_google_map_shortcode'] = array(
            'title' => __('Google Map', "Cloth-Store"),
            'desc' => __('To use Copy/Paste the above shortcode', "Cloth-Store"),
            'type' => 'shortcode',
            'std' => '[googlemap]',
            'section' => 'shortcodes'
        ...
        $this->settings['ttr_private_content_shortcode'] = array(
            'title' => __('Private Content', "Cloth-Store"),
            'desc' => __('To use Copy/Paste the above shortcode', "Cloth-Store"),
            'type' => 'shortcode',
        ...
        /*$this->settings['ttr_contact_us_form_shortcode'] = array(
            'title' => __('Contact Us Form', "Cloth-Store"),
            'desc' => __('To use Copy/Paste the above shortcode', "Cloth-Store"),
            'type' => 'shortcode',
            'std' => '[contact_us_form]',
            'section' => 'shortcodes'
        ...
        $this->settings['ttr_login_form_shortcode'] = array(
            'title' => __('Login Form', "Cloth-Store"),
            'desc' => __('To use Copy/Paste the above shortcode', "Cloth-Store"),
            'type' => 'shortcode',
        ...
        $this->settings['ttr_custommenu_shortcode'] = array(
            'title' => __('Custom Menu', "Cloth-Store"),
            'desc' => __('To use Copy/Paste the above shortcode', "Cloth-Store"),
            'type' => 'shortcode',
        ...
        $this->settings['ttr_categories_shortcode'] = array(
            'title' => __('Categories', "Cloth-Store"),
            'desc' => __('To use Copy/Paste the above shortcode', "Cloth-Store"),
            'type' => 'shortcode',
        ...
        $this->settings['ttr_recent_comments_shortcode'] = array(
            'title' => __('Recent Comments', "Cloth-Store"),
            'desc' => __('To use Copy/Paste the above shortcode', "Cloth-Store"),
            'type' => 'shortcode',
        ...
        $this->settings['ttr_recent_posts_shortcode'] = array(
            'title' => __('Recent Posts', "Cloth-Store"),
            'desc' => __('To use Copy/Paste the above shortcode', "Cloth-Store"),
            'type' => 'shortcode',
        ...
        $this->settings['ttr_tagcloud_shortcode'] = array(
            'title' => __('Tag Cloud', "Cloth-Store"),
            'desc' => __('To use Copy/Paste the above shortcode', "Cloth-Store"),
            'type' => 'shortcode',
       ...
       ===========================================*/
        ...
        $this->settings['ttr_ftp_server_address'] = array(
            'title' => __('FTP Server Address', "Cloth-Store"),
            'desc' => __('Enter the FTP Address ', "Cloth-Store"),
            'std' => '',
            'type' => 'text',
            'section' => 'backupsettings'
        );
        $this->settings['ttr_ftp_user_name'] = array(
            'title' => __('FTP User name', "Cloth-Store"),
            'desc' => __('Enter the FTP username ', "Cloth-Store"),
            'std' => '',
            'type' => 'text',
            'section' => 'backupsettings'
        );
        $this->settings['ttr_ftp_user_password'] = array(
            'title' => __('FTP User password', "Cloth-Store"),
            'desc' => __('Enter the FTP password ', "Cloth-Store"),
            'std' => '',
            'type' => 'password',
            'section' => 'backupsettings'
        );
        $this->settings['ttr_ftp_recipient_email'] = array(
            'title' => __('Email of recipient', "Cloth-Store"),
            'desc' => __('Enter the name of email recipient ', "Cloth-Store"),
            'std' => '',
            'type' => 'text',
            'section' => 'backupsettings'
        );
        $this->settings['ttr_ftp_check_connection'] = array(
            'title' => __('Check FTP Connection', "Cloth-Store"),
            'desc' => __('Click to check the FTP Connection Status', "Cloth-Store"),
       ...
       ===========================================*/
        ...
        $this->settings['ttr_manual_database_backup'] = array(
            'title' => __('Database Backup (.sql file)', "Cloth-Store"),
            'desc' => __('Add/Remove database (.sql) file to Backup zip', "Cloth-Store"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'backup'
        );
        $this->settings['ttr_automatic_backup_recovery_enable'] = array(
            'title' => __('Enable Automatic Backup/Recovery Mode)', "Cloth-Store"),
            'desc' => __('Enable/Disable Automatic Backup/Recovery Mode', "Cloth-Store"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'backup'
        );
        $this->settings['ttr_include_plugin_backup'] = array(
            'title' => __('Include Plugins', "Cloth-Store"),
            'desc' => __('Include/Exclude plugins to Backup Zip', "Cloth-Store"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'backup'
        );
        $this->settings['ttr_include_theme_backup'] = array(
            'title' => __('Include Themes', "Cloth-Store"),
            'desc' => __('Include/Exclude themes to Backup Zip', "Cloth-Store"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'backup'
        );
        $this->settings['ttr_include_uploads_backup'] = array(
            'title' => __('Include Uploads', "Cloth-Store"),
            'desc' => __('Include/Exclude uploads to Backup Zip', "Cloth-Store"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'backup'
        );
        $this->settings['ttr_backup_folder_name'] = array(
            'title' => __('Backup Folder Name', "Cloth-Store"),
            'desc' => __('Set the folder name to take the backup', "Cloth-Store"),
            'std' => 'Backup',
            'type' => 'text',
            'section' => 'backup'
        );
        $this->settings['ttr_automatic_backup_interval'] = array(
            'title' => __('Automatic Backup intervals', "Cloth-Store"),
            'desc' => __('Select the database interval to take backup', "Cloth-Store"),
            'type' => 'select',
            'std' => '-Select-',
            'choices' => array(
                'choice1' => __('Every 10 mins', "Cloth-Store"),
                'choice2' => __('Every hour', "Cloth-Store"),
                'choice3' => __('Every 4 hours', "Cloth-Store"),
                'choice4' => __('Every 8 hours', "Cloth-Store"),
                'choice2' => __('Every 12 hours', "Cloth-Store"),
                'choice3' => __('Daily', "Cloth-Store"),
                'choice4' => __('Weekly', "Cloth-Store")),
            'section' => 'backup'
        );
        $this->settings['ttr_storage_backup'] = array(
            'title' => __('Choose your Remote Storage', "Cloth-Store"),
            'desc' => __('Set time to the backup', "Cloth-Store"),
            'type' => 'select',
            'std' => '-Select-',
            'choices' => array(
                'choice1' => __('FTP', "Cloth-Store"),
                'choice2' => __('Email', "Cloth-Store")),
            'section' => 'backup'
        );
        $this->settings['ttr_backup_folder_name'] = array(
            'title' => __('Backup Folder Name', "Cloth-Store"),
       ...
       ===========================================*/
        ...
        $this->settings['ttr_browse'] = array(
            'title' => __('Select Backup Folder', "Cloth-Store"),
            'desc' => __('Select the folder(.zip file only)', "Cloth-Store"),
            'std' => '',
            'type' => 'file',
            'section' => 'restore'
        );
        $this->settings['ttr_include_database_restore'] = array(
            'title' => __('Restore Database(.sql)', "Cloth-Store"),
            'desc' => __('Enable/Disable to restore databases for Site', "Cloth-Store"),
            'std' => 0,
            'type' => 'checkbox',
            'section' => 'restore'
        );
        $this->settings['ttr_include_theme_restore'] = array(
            'title' => __('Restore Themes', "Cloth-Store"),
            'desc' => __('Enable/Disable to restore theme folder for Site', "Cloth-Store"),
            'std' => 0,
            'type' => 'checkbox',
            'section' => 'restore'
        );
        $this->settings['ttr_include_plugins_restore'] = array(
            'title' => __('Restore Plugins', "Cloth-Store"),
            'desc' => __('Enable/Disable to restore plugins folder for Site', "Cloth-Store"),
            'std' => 0,
            'type' => 'checkbox',
            'section' => 'restore'
        );
        $this->settings['ttr_include_uploads_restore'] = array(
            'title' => __('Restore Uploads', "Cloth-Store"),
            'desc' => __('Enable/Disable to restore uploads folder for Site', "Cloth-Store"),
            'std' => 0,
            'type' => 'checkbox',
            'section' => 'restore'
        );
    ...
    public function scripts()
    {
        ...
        $translations = array_merge(array('tt_xmlerror' => (__('Please, select an xml file','Cloth-Store')), 'tt_savechanges' => (__('No changes to export in Theme Options. Please save your changes properly.','Cloth-Store'))));
    ...
    public function validate_settings($input)
    {
        ...
        foreach ($this->settings as  $key => $value)
        {
 			if($key == 'ttr_designedby_link_url')
            {
               ...
               { 
                 add_settings_error('templatetoaster_theme_options','errorMsg',__("Please enter a valid URL", "Cloth-Store"),'error') ;
			     return $options;
              }             
            }
