...
<li role="presentation"><a data-toggle="tab" aria-controls="tt_editor_tab1" href="#tt_editor_tab1" role="tab" >' . __( 'Default Editor','Cloth-Store') . '</a></li>
<li class="active" role="presentation"><a data-toggle="tab" aria-controls="tt_editor_tab2" href="#tt_editor_tab2" role="tab">' . __( 'Custom Editor','Cloth-Store') . '</a></li>
</ul>';
...
if($id != $page_for_posts)
{
echo'</div><div class="tab-pane fade active show" id="tt_editor_tab2" role="tabpanel">';
